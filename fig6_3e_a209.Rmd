...
dmso_acute <- ggplot(data = dmso, aes(x = LFC_rna_DMSO, y = LFC_ribo_DMSO)) + 
  ...
  geom_vline(xintercept = 0, color = "grey") +
  geom_point(alpha=.25) +
  ylab(bquote(Log[2]~"Fold Change DMSO"~"RIBO: hypoxia vs normoxia")) +
  xlab(bquote(Log[2]~"Fold Change DMSO"~"RNA: hypoxia vs normoxia")) +
    theme_cowplot(font_size = 16)+
  theme_prism()
...
scatter <- ggplot(data = sig_DMSO, aes(x = LFC_te_DMSO, y = LFC_te_a209)) + 
  ...
  geom_vline(xintercept = 0, color = "grey") +
  geom_point(alpha=.25) +
  ylab(bquote(Log[2]~"Fold Change a209"~"TE: hypoxia vs normoxia")) +
  xlab(bquote(Log[2]~"Fold Change DMSO"~"TE: hypoxia vs normoxia")) +
    theme_cowplot(font_size = 16)+
  theme_prism()
...
ggsave(here("plots/norm_3e_a209_te_scatter.pdf"), scatter)
...
ggsave(here("plots/hyp_3e_a209_te_scatter.pdf"), scatter)
...
ggsave(here("plots/normoxia_hallmarks.pdf"), hallmarks)
...
ggsave(here("plots/hypoxia_hallmarks.pdf"), hallmarks)
