...
ggsave(here("plots/sictrl_counts.pdf"), width=3, height=3)
```
...
#ggsave(scatter, height=4, width=4, path= here("plots/acute_3e.pdf"))
...
ggsave(here("plots/eIF3dbars.pdf"), eif3d_bar, width = 2.5, height = 3)
...
ggsave(here("plots/norm_e_d.pdf"), scatter, height=4, width=4)
...
ggsave(here("plots/hyp_e_d.pdf"), width=4, height=4)
...
write_xlsx(list(normoxia = norm_sig_te, hypoxia = hyp_sig_te), path= here("counts/3e_3d_te.xlsx"))
...
saveWorkbook(wb, file = here("counts/rna_values.xlsx"), overwrite = TRUE)
...
# Save the workbook to an Excel file
saveWorkbook(wb, file = here("counts/rna_values_sig.xlsx"), overwrite = TRUE)
