...
### Some plots are not ggsaving in the correct dimensions. need to fix.
...
ggsave(filename = here("plots/fig3/rna_ribo_acute.pdf"), width = 4, height = 4)
...
ggsave(filename= here("plots/fig3/acute_3e.pdf"), height=4, width=4)
...
ggsave(here("plots/fig3/acute_3d.pdf"), height=4, width=4)
...
ggsave(here("plots/fig3/eIF3ebars.pdf"), eif3e_bar, width = 2.5, height = 3)
...
ggsave(here("plots/fig3/eIF3dbars.pdf"), eif3d_bar, width = 2.5, height = 3)
...
ggsave(here("plots/fig3/hyp_e_d.pdf"), width=4, height=4)
