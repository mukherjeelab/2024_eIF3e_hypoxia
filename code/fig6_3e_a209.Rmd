...
### TE signatures --- In These signatures are opposite to what we did earlier -- so there is an eIF3e signature (not eIF3e KD signature. eIF3e signature means a lot of eFI3e activity (rather than KD))
