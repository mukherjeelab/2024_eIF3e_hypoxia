...
ggsave(filename= here("plots/fig6/acute_dmso_a209.pdf"), scatter, height=4, width=4)
...
ggsave(here("plots/fig6/a209bars.pdf"), eif3e_bar, width = 3, height = 4)
...
Scatterplot of eFI3e vs a209 in hypoxia
...
hyp_sig_te <- data.frame(
  gene_id = res_hypox_si3e$gene_id,
  symbol = res_hypox_si3e$symbol,
  te_a209 = res_hypox_a209$log2FoldChange,
