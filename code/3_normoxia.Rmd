...
# Figure: Overlap between functions of eIF3e and eIF3d in normoxia
...
write_csv(res_te_3d, here("counts/normoxia_sictrl_3d.csv"))
```
...
write_csv(res_te_3e, here("counts/normoxia_sictrl_3e.csv"))
...
ggsave(width = 5.5, height = 3.75, filename = here("plots/commongenes.pdf"))
...
ggsave(width = 5.5, height = 2.5, filename = here("plots/dgenes.pdf"))
...
ggsave(width = 5.5, height = 2.5, filename = here("plots/egenes.pdf"))
...
ggsave(here("plots/example_genes.pdf"), width = 4, height = 4)
```
...
ggsave(here("plots/e_d_rna_ribo.pdf"), width = 4, height = 4.5)
...
ggsave(width = 5, height = 5, filename = here("plots/normoxia_quadrants.pdf"))
...
ggsave(here("plots/eIF3e_hypoxiapathway.pdf"), width=6, height=5)


gseaplot(eif3d_te_h, geneSetID= "HALLMARK_HYPOXIA", color.line = si3d_col, color.vline = si3d_col)
ggsave(here("plots/eIF3d_hypoxiapathway.pdf"), width=6, height=5)
