...
This is probably not needed for the paper. Unless we add something with TE sigantures. But, we need a place to calcualte these for our other work.

TE signatures generated already, can pull in, then export subset.
RNA signatures generated for eIF3e and eIF3d in hypoxia in fig 8
...
KD_te_sig_3e_norm <- read_csv(here("counts/fig1/normoxia_sictrl_3e.csv"))
...
```{r}
KD_te_sig_3d_norm <- read_csv(here("counts/fig1/normoxia_sictrl_3d.csv"))
...
KD_te_sig_3e_hyp <- read_csv(here("counts/fig3/hypoxia_si_ctrl_3e.csv"))
...
```{r}
KD_te_sig_3d_hyp <- read_csv(here("counts/fig3/hypoxia_si_ctrl_3d.csv"))
...
KD_te_sig_a209_norm <- read_csv(here("counts/fig6/normoxia_dmso_a209.csv"))
...
KD_te_sig_a209_hyp <- read_csv(here("counts/fig6/hypoxia_dmso_a209.csv"))
