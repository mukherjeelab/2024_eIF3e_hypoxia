...
write_csv(all_raw_filtered_counts, here("calculate_te/raw_filtered_allCounts.csv"))
...
#   dplyr::select(-Hypoxic_si3e_RepB_rnaseq)

#export complete list

write_csv(complete_list, here("calculate_te/complete_te_list.csv"))
