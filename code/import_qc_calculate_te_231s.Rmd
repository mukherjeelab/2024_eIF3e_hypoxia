...
# metabric_cna <- read.table(here("cbioportal_data/data_cna.txt"), fill=TRUE, header=TRUE) %>% 
#   dplyr::select(-Entrez_Gene_Id)
...
ggsave("cna_3e.pdf", path=here("plots/fig8/tcga"),width = 8, height=6)
...
ggsave("cna_3d.pdf", path=here("plots/fig8/tcga"),width = 8, height=6)
...
ggsave("cna_percentages.pdf", path=here("plots/fig8/tcga"),width = 4, height=2)
