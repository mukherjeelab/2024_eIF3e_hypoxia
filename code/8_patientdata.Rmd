---
title: "3e/d RNA signatures in patient data"
author: "Kate"
date: "2024-08-27"
...
# export to excel ---------------------------------------------------------------
   ...
   writexl::write_xlsx(x = res_hyp_3e, path = here("counts/rna_signature_3e_hypoxia.xlsx"), col_names = T)
...
# export to excel ---------------------------------------------------------------
   ...
   writexl::write_xlsx(x = res_hyp_3d, path = here("counts/rna_signature_3d_hypoxia.xlsx"), col_names = T)
...
# export to excel ---------------------------------------------------------------
   ...
   writexl::write_xlsx(x = res_norm_3e, path = here("counts/rna_signature_3e_normoxia.xlsx"), col_names = T)
...
# export to excel ---------------------------------------------------------------
   ...
   writexl::write_xlsx(x = res_norm_3d, path = here("counts/rna_signature_3d_normoxia.xlsx"), col_names = T)
...
ggsave("3e_norm_surv_plot.pdf", path=here("plots"),width = 11.5, height=8)
...
ggsave("surv_plot_3e_and_hypoxia_sig.pdf", path=here("plots"),width = 11.5, height=8)
...
Keeping this commented out because it takes forever
...
ggsave("tcga_3e.pdf", path=here("plots"),width = 8, height=6)
...
ggsave("tcga_3d.pdf", path=here("plots"),width = 8, height=6)
...
ggsave("surv_plot_ye_hyp_tcga.pdf", path=here("plots"),width = 8, height=6)
...
METABRIC
```{r}
cna <- read.table(here("cbioportal_data/brca_metabric/data_cna.txt"), fill=TRUE, header=TRUE) %>% 
  dplyr::select(-Entrez_Gene_Id)
...
ggsave("cna_3e.pdf", path=here("plots"),width = 8, height=6)
...
ggsave("cna_3d.pdf", path=here("plots"),width = 8, height=6)
...
ggsave("cna_percentages.pdf", path=here("plots"),width = 4, height=2)
...
ggsave("cna_myc.pdf", path=here("plots"),width = 11.5, height=8)
