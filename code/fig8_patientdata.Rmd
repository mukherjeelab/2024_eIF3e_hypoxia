...
colors <- grDevices::colorRampPalette(c("grey", "red"))(4)
...
ggsurvplot(fit_all_data_hif_ye,
           ...
           palette = colors, 
           break.time.by = 1,
          legend.labs=c("Low Hypoxia", "Med-Low Hypoxia", "Med-High Hypoxia", "High Hypoxia"),
           ylab="Overall Survival",
           xlab = "Time in years",
           xlim = c(0,10),
           font.x = 30,      
...
ggsurvplot(fit_all_hypoxia_3e,
           ...
           size = 1,
           palette = c("#9B4D96", "red", "grey", si3e_col), 
           break.time.by = 1,
           ylab="Overall Survival",
           xlab = "Time in years",
           xlim = c(0,10),
...
ggsave("surv_plot_ye_hyp_tcga.pdf", path=here("plots/fig8"),width = 11.5, height=8)
...
## Looking at copy number alterations in data - @Kate probably delete for manuscript, everything below
