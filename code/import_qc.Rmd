...
@Neel, here, I am not filtering for protein coding only as I do in calculate_te.Rmd.  Should I use that filter here?
...
Correlation coefficients after outlier is removed

 @Kate delete if not used in text
```{r}
