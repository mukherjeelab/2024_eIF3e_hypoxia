...
heatmap
ggsave(heatmap, filename=here("plots/qc/heatmap_norm_kds.pdf"), width=11.5, height=11)
...
PCAs for figure 1 -- @Kate - decide whether to delete
```{r}
#kds only pca
...
with outlier- @Kate remove?

```{r}
mycor_hyp_kds <- cor(qc_input_hypoxia_kds, method = "pearson")
heatmap_hypoxia <- pheatmap::pheatmap(mat = mycor_hyp_kds)
heatmap_hypoxia
ggsave(heatmap_hypoxia, filename=here("plots/qc/heatmap_hyp_kds.pdf"), width=11.5, height=11)
...
heatmap_normoxia
ggsave(heatmap_normoxia, filename=here("plots/qc/heatmap_norm_compound.pdf"), width=11.5, height=11)
...
heatmap_hypoxia
ggsave(heatmap_hypoxia, filename=here("plots/qc/heatmap_hyp_compound.pdf"), width=11.5, height=11)
