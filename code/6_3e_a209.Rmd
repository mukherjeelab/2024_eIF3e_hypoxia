...
ggsave(here("plots/hif_a209_hypoxia.pdf"), width = 4, height = 3)
...
ggsave(here("plots/acute_DMSO_counts.pdf"), width=4, height=4)
...
write_csv(all_changes_dmso_a209, here("counts/all_norm_to_hyp_changes_compound.csv"))
```
...
ggsave(filename = here("plots/rna_ribo_DMSO_acute.pdf"), DMSO_acute, width = 4, height = 4)
...
ggsave(filename= here("plots/acute_dmso_a209.pdf"), scatter_acute_dmso_a209, height=4, width=4)
...
write_csv(res_normox_a209, here("counts/normoxia_dmso_a209.csv"))
...
write_csv(res_hypox_a209, here("counts/hypoxia_dmso_a209.csv"))
...
ggsave(here("plots/a209bars.pdf"), a209_bar, width = 3, height = 4)

```

# Compare a209 to eIF3d and eIF3e
## Import TE changes for eIF3d and eIF3e in normoxia nad hypoxia
Pull normoxia data from previous analysis
```{r}
...
#3d
res_hypox_si3d <-read_csv(here("counts/hypoxia_si_ctrl_3d.csv"))
...
#3e
res_hypox_si3e <-read_csv(here("counts/hypoxia_si_ctrl_3e.csv"))
...
ggsave(here("plots/normoverlap.pdf"), width=4, height=4)
...
ggsave(filename=here("plots/hypoverlap.pdf"), width=4, height=4)
