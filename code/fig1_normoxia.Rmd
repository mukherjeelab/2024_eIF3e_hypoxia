...
ggsave(width = 4, height = 4.25, filename = here("plots/commongenes.pdf"))
...
ggsave(width = 4, height = 1.75, filename = here("plots/dgenes.pdf"))
...
ggsave(width = 4, height = 1.75, filename = here("plots/egenes.pdf"))
...
ggscatter(data = norm_te_h,
          ...
          repel = TRUE,
          font.label = 11,
          xlab="eIF3d - Normalized Enrichment Score",
          ylab = "eIF3e - Normalized Enrichment Score")+
