...
```{r}
d_genes <- c("CLDN9", "CLIC1", "EIF3D")
e_genes <- c("APLP2", "PABPC1", "TOR1AIP2")
common <- c("ATF4", "EIF4EBP2", "GSK3B", "JUN", "MED13L", "PCBP2", "WNK1", "XBP1", "YKT6")
```
...
ggvenn(norm_te_up, auto_scale = T, fill_color = c(si3d_col,si3e_col), text_size = 10)

ggvenn(norm_te_down, auto_scale = T, fill_color = c(si3d_col,si3e_col), text_size = 10)
...
ggscatter(data = norm_te_h,
          ...
          repel = TRUE,
          font.label = 11,
          xlab="eIF3d - Net Enrichment Score",
          ylab = "eIF3e - Net Enrichment Score")+
