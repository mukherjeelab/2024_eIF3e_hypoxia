...
export common d and e only for neel to visualize differently
...
write_csv(three_cats, here("counts/example_genes.csv"))
...
@Neel not sure we want this. Or maybe we want this without a line and with just an R-squared value?
```{r}
