...
# @kate -> geneInfo has transcript level information that you do NOT want because it messes up the join and creates > 100K rows! You only need geneInfo[,c(1,4)] rather than geneInfo. Everything below that uses `te_norm` will be messed up.
...
allCountsNorm[e_and_d,] %>% 
  ...
  ggplot(aes(x = kd, y = value, color = type)) +
  geom_jitter() +
