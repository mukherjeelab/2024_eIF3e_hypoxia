...
TE normoxic only. For this figure. Hypoxia is still in here for now. We can decide to remove it with the finished paper.
...
ggsave(height=4, width=4, here("plots/atf4_normoxic_kds.pdf"))
